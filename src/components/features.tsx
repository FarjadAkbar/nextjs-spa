...
export default function Features() {
  const { item_1, item_2, item_3, item_4, item_5 } = en.features
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[0.8fr_1fr_1fr] gap-6">
          ...
          <div className="rounded-xl bg-purple-50 p-4 md:p-5 border border-purple-200">
            ...
            dangerouslySetInnerHTML={{ __html: item_1.title }}
            />
          ...
          <div className="grid grid-rows-2 gap-6">
            ...
            <div className="row-span-3 rounded-xl bg-gray-50 p-4 md:p-5 border border-gray-200">
              <h3 className="text-base md:text-lg font-bold mb-2">{item_2.title}</h3>
              <p className="text-xs md:text-sm text-gray-600 mb-6">
                {item_2.description}
              </p>
            ...
            <div className="row-span-1 rounded-xl bg-white p-4 md:p-5 border border-gray-200">
              ...
              <div className="flex-1">
                <h3 className="text-base md:text-lg font-bold mb-3">{item_3.title}</h3>
          ...
          <div className="grid grid-rows-2 gap-6">
            ...
            <div className="row-span-2 rounded-xl bg-white border border-gray-200 p-4 md:p-5">
               <h3 className="text-base md:text-lg font-bold mb-6">{item_4.title}</h3>
            
                <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    <Heart className="w-8 h-8 md:w-9 md:h-9 text-purple-600 fill-purple-600" />
                    <span className="text-xl md:text-3xl font-bold">{item_4.likes}</span>
                </div>
                <Image
            ...
            <div className="row-span-2 rounded-xl bg-white border border-gray-200 p-4 md:p-5">
              <h3 className="text-base md:text-lg font-bold mb-4">{item_5.title}</h3>
            <p className="text-xs md:text-sm text-gray-600 mb-6">
              {item_5.description}
            </p>
            
            <div className="bg-gray-50 rounded-lg p-4 md:p-5">
              <h4 className="text-sm md:text-base font-bold mb-4">{item_5.title}</h4>
              
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-3xl md:text-4xl font-bold mb-2">{item_5.profit}</div>
                  <p className="text-xs text-purple-600 font-semibold">{item_5.growth}</p>
                </div>
